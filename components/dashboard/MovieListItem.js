  ...
  return (
    <Link href={href} className="group border dark:border-neutral-800 shadow flex gap-4 focus-visible:outline-none focus-visible:ring focus-visible:ring-emerald-500 rounded" {...props}>
      <div className="w-[88px]">
        <div className="relative h-32 w-[88px] overflow-hidden">
          {imageSrc ?
            ...
            />
            :
            <div className="h-full w-full rounded-l bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center">
      ...
      <div className="pt-3.5 pr-3">
        <Text.semibold className="!text-[15px] mb-1 line-clamp-2 group-hover:text-emerald-500 transition-all duration-500">{name}</Text.semibold>
