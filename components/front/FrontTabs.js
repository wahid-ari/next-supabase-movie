...
export default function FrontTabs({ items, children, className }) {
  return (
    <Tab.Group>
      ...
      >
        <div className='flex gap-x-4 overflow-x-auto py-2 scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300 dark:scrollbar-thumb-neutral-800 sm:gap-x-8'>
