...
const strukturSchema = yup.object().shape({
  ...
  nip: yup
    ...
    .integer('NIP harus valid')
    .typeError('NIP harus valid'),
  name: yup
    .string()
...
export const validateJabatan = async (data) => {
  try {
...
export const validateStruktur = async (data) => {
  try {
