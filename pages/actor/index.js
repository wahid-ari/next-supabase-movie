    ...
    () => [
      ...
      },
      {
        ...
        Cell: (row) => {
          ...
          return (
            <Link href={`actor/detail/${values.id}`} className="text-emerald-500 hover:text-emerald-600 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-500 rounded">
              {values.name}
            </Link>
          )
        }
      ...
      },
      {
        ...
        Cell: (row) => {
          ...
          return (
            <div>
              <Link href={`actor/edit/${values.id}`} className="py-[3px] px-[6px] bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-400 text-sm font-medium mr-2 text-white rounded">
                Edit
              </Link>
  ...
  return (
    <Layout title="Actor - MyMovie">
      <div className="flex flex-wrap justify-between items-center mb-6 gap-y-3">
        <Title>Actor</Title>
        <LinkButton href="actor/add" className="flex gap-2 items-center">
          <PlusSmIcon className="h-5 w-5" />Add Actor
        </LinkButton>
      </div>
