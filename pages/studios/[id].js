...
function Page({ id }) {
  ...
  return (
    ...
    >
      <div className='py-2'>{data ? <Title>{data?.name}</Title> : <Title>Studio Detail</Title>}</div>
      ...
      {data ? (
        data?.movies.length > 0 ? (
          <>
            ...
            <div className='grid grid-cols-2 gap-8 sm:grid-cols-3 min-[840px]:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
